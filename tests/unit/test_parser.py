...
from src.ttgdtparser.constants import raspisanie_zanyatij, zam, groups
...
from src.ttgdtparser.parser import LessonTableParser, ChangesTableParser, GroupsParser
